...
module RFinvoice
  class DeliveryDetails < Model
    add_complex_properties %w(DeliveryDate DeliveryPeriodDetails ShipmentPartyDetails), required: false
    ...
    add_complex_properties %w(TransportInformationDate), required: false
