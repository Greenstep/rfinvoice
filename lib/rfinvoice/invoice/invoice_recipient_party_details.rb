...
module RFinvoice
  class InvoiceRecipientPartyDetails < Model
    add_string_simple_properties '0_35', %w(InvoiceRecipientPartyIdentifier), required: false
    ...
    add_string_simple_properties '0_35', %w(InvoiceRecipientOrganisationTaxCode), required: false
    add_complex_properties %w(InvoiceRecipientCode InvoiceRecipientPostalAddressDetails), required: false
  end
end
