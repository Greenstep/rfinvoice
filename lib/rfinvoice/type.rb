...
require 'rfinvoice/type/epi_remittance_info_identifier_pattern_type'
require 'rfinvoice/type/epi_remittance_info_identifier_scheme_type'
require 'rfinvoice/type/charge_option_type'
