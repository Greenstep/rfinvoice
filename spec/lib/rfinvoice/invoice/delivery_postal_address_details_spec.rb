...
RSpec.describe ::RFinvoice::DeliveryPostalAddressDetails do
  ...
  it_should_behave_like 'a typed attributes', %w(DeliveryTownName DeliveryPostCodeIdentifier), 'String2_35', true
  ...
  it_should_behave_like 'a typed array attributes', %w(DeliveryStreetName), ::RFinvoice::Type::Array1_3, 'String2_35', true
end