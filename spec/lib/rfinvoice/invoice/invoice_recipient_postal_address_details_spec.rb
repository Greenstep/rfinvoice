...
RSpec.describe ::RFinvoice::InvoiceRecipientPostalAddressDetails do
  ...
  it_should_behave_like 'a typed attributes', %w(InvoiceRecipientTownName InvoiceRecipientPostCodeIdentifier), 'String2_35', false
  ...
  it_should_behave_like 'a typed array attributes', %w(InvoiceRecipientStreetName), ::RFinvoice::Type::Array1_3, 'String2_35', false
end
