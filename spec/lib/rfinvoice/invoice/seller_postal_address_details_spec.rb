...
RSpec.describe ::RFinvoice::SellerPostalAddressDetails do
  ...
  it_should_behave_like 'a typed attributes', %w(SellerTownName SellerPostCodeIdentifier), 'String2_35', false
  ...
  it_should_behave_like 'a typed array attributes', %w(SellerStreetName), ::RFinvoice::Type::Array1_3, 'String2_35', false
end
