...
RSpec.describe ::RFinvoice::ShipmentPostalAddressDetails do
  ...
  it_should_behave_like 'a typed attributes', %w(ShipmentTownName ShipmentPostCodeIdentifier), 'String2_35', true
  ...
  it_should_behave_like 'a typed array attributes', %w(ShipmentStreetName), ::RFinvoice::Type::Array1_3, 'String2_35', true
end