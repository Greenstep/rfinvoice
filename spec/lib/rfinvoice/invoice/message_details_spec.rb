...
RSpec.describe ::RFinvoice::MessageDetails do
  ...
  it { is_expected.to have_virtus_attribute(:message_identifier).of_type(::RFinvoice::Type::String2_48).with_required(false) }
  it { is_expected.to have_virtus_attribute(:message_time_stamp).of_type(::RFinvoice::Type::String2_35).with_required(false) }
