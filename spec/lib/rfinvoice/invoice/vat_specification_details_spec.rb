...
RSpec.describe ::RFinvoice::VatSpecificationDetails do
  ...
  it_should_behave_like 'a complex attributes', %w(VatBaseAmount VatRateAmount), false
  it_should_behave_like 'a typed attributes', %w(VatCode), 'String0_10', false
  it_should_behave_like 'a typed attributes', %w(VatRatePercent), 'Percentage', false
