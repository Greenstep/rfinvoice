...
RSpec.describe ::RFinvoice::BuyerPartyDetails do
  ...
  it_should_behave_like 'a typed array attributes', %w(BuyerOrganizationDepartment), ::RFinvoice::Type::Array0_2, 'String0_35', false
  it_should_behave_like 'a typed array attributes', %w(BuyerOrganisationName), ::RFinvoice::Type::Array1_1000, 'String2_35', true
