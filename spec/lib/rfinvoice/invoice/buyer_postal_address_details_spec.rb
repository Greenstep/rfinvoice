...
RSpec.describe ::RFinvoice::BuyerPostalAddressDetails do
  ...
  it_should_behave_like 'a typed attributes', %w(BuyerTownName BuyerPostCodeIdentifier), 'String2_35', true
  ...
  it_should_behave_like 'a typed array attributes', %w(BuyerStreetName), ::RFinvoice::Type::Array1_3, 'String2_35', true
end