...
RSpec.describe ::RFinvoice::Decorator::DeliveryDetails do
  ...
  it_should_behave_like 'a decorated properties', %w(ShipmentPartyDetails DeliveryPeriodDetails PackageDetails)
  it_should_behave_like 'a modelized properties', %w(DeliveryDate TransportInformationDate), 'Date'
